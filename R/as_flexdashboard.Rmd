...
flexdashboard::valueBox(
  value = paste0(round(nrow(animals) / 1000), "K"),
...
```{r}
valueBox(
  value = scales::percent(mean(animals$gender == "Female")),
  caption = "female"
)
```
...
# renderValueBox(
  valueBox(
    value = percent(mean(fct_lump_n(animals$breed, n = 30) == "Other")),
    caption = "from less popular breeds"
  )
# )
```
