...
animals %>%
  ...
  select(species, age_group, age, breed, breed_specific, locality, sterile) %>%
...
* can you add a toggle for cats vs dogs `shinyWidgets::radioGroupButtons()`
* Questions
...
### more ideas
* most poular gender neutral names
...
* Upload pictures: https://drive.google.com/drive/folders/1NqUKWiYBsroxDYlUliB6_bdh4YKE94jO?usp=sharing
