...
renderValueBox({
  valueBox(                                                # < --------
    value = percent(mean(filtered_data()$sterile)), 
...
renderValueBox({
  valueBox(                                                # < --------
    value = comma(sum(filtered_data()$species == "Cat")),
    caption = "Cats",
    color = color_cats
  )
})
...
renderValueBox({
  valueBox(                                                # < --------
    value = comma(sum(filtered_data()$species == "Dog")),
    caption = "Dogs",
    color = color_dogs
  )
})
...
DT::renderDataTable({
  ...
  nice_datatable(df, caption = glue("Top {input$n} Pet Names")) # < --------
})
